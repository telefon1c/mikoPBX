...
class Selectel extends CloudProvider
{
    public const string CloudID = 'Selectel';
    ...
    public function provision(): bool
    {
        ...
        if ($checkValue === 'aws') {
            return false; // It is AWS, not Selectel
        }
        ...
        $this->updateSSHCredentials('selectel-user', $vmId);
